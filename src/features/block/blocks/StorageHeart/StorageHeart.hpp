...
public:
	inline static const std::string identifier = "magic_storage:storage_heart";
...
public:
	...
	virtual void registerItem(RegisterItemsEvent& ev) override {
		auto& constructionTab = ev.mCreativeItemRegistry.GetVanillaCategory(CreativeItemCategory::Items);
